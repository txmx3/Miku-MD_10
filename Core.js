...
if (antiVirtex) {
    ...
    if (AntiLink) {
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} Der Benutzer wurde für das Senden von Link in diesem entfernt!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} Der Benutzer wurde für das Senden eines Yt-Videolinks in dieser Gruppe entfernt!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} Der Benutzer wurde für das Senden eines Youtube-Kanallinks in dieser Gruppe entfernt!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} Der Benutzer wurde für das Senden eines Instagram-Links in dieser Gruppe entfernt!  Keine Förderung erlaubt!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} Der Benutzer wurde für das Senden eines Facebook-Links in dieser Gruppe entfernt!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} Der Benutzer wurde für das Senden eines Telegram-Links in dieser Gruppe entfernt!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} Der Benutzerwurde für das Senden eines Tiktok-Links in dieser Gruppe entfernt!!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        if (!isBotAdmins) return
        bvl = `\`\`\`「  Antilink System  」\`\`\`\n\nLink Der Administrator hat einen Link gesendet, sodass keine Maßnahmen ergriffen werden.!`
        if (isAdmins) return reply(bvl)
        if (m.key.fromMe) return reply(bvl)
        if (isCreator) return reply(bvl)
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} Der Benutzer wurde für das Senden eines Twitter-Links in dieser Gruppe entfernt!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} Der Benutzer wurde für das Senden eines Externen-Links in dieser Gruppe entfernt!  Keine Förderung erlaubt!!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
...
let cron = require('node-cron')
    ...
    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
      ...
      await Miku.sendButtonText(m.chat, [{ buttonId: 'guess song', buttonText: { displayText: 'Errate den Song }, type: 1 }], `🎮 Guess The Song 🎮\n\nCorrect answer 🎉\n\nWant to play again? press the button below`, `${global.BotName}`, m)
      ...
      if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
        ...
        if (budy.toLowerCase() == jawaban) {
        await Miku.sendButtonText(m.chat, [{ buttonId: 'guess picture', buttonText: { displayText: 'Errate das Bild' }, type: 1 }], `🎮 Guess The Picture 🎮\n\nCorrect Answer 🎉\n\nWant to play again? press the button below`, `${global.BotName}`, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
          ...
          if (budy.toLowerCase() == jawaban) {
          await Miku.sendButtonText(m.chat, [{ buttonId: 'guess word', buttonText: { displayText: 'Errate das Wort' }, type: 1 }], `🎮 Guess The Word 🎮\n\nCorrect Answer 🎉\n\nWant to play again? press the button below`, `${global.BotName}`, m)
          ...
          if (budy.toLowerCase() == jawaban) {
          await Miku.sendButtonText(m.chat, [{ buttonId: 'guess sentence', buttonText: { displayText: 'Errate den Satz' }, type: 1 }], `🎮 Guess The Sentence 🎮\n\nCorrect Answer 🎉\n\nWant to play again? press the button below`, `${global.BotName}`, m)
          ...
          if (budy.toLowerCase() == jawaban) {
          await Miku.sendButtonText(m.chat, [{ buttonId: 'guess lyrics', buttonText: { displayText: 'Errate den Songtext(Abschnit)' }, type: 1 }], `🎮 Guess The Lyrics 🎮\n\nCorrect Answer 🎉\n\nWant to play again? press the button below`, `${global.BotName}`, m)
          ...
          roof.text = m.text
          reply('Du hast gewählt ${m.text} ${!roof.pilih2 ? `\n\nWarten auf den Gegner , den sie gewählt haben' : ''}`)
          if (!roof.pilih2) Miku.sendText(roof.p2, '_Der Gegner wurde gewählt_\nNow it is your turn', 0)
          }
          if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
          roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
          roof.text2 = m.text
          reply(`Du hast gewählt ${m.text} ${!roof.pilih ? `\n\nWarten sie auf den Gegner , den sie gewählt haben` : ''}`)
          if (!roof.pilih) Miku.sendText(roof.p, '_Der Gegner wurde gewählt\nNow it is your turn', 0)
          }
          ...
          if (kuismath.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
            await reply(`「 *Mathe Quiz* 」\n\n 🎉 Richtige Antwort 🎉\n\nMöchtest du erneut spielen? sende ${prefix}Mathe modus`)
...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    KoniHi ${pushname} Hallo👋. Ich bin ${global.BotName}, Ein Bot erstellt von: "Max_2" um dein WhatsApp auf ein neues Level zu bekommen.
    ...
    Type *#menu* oder drücken Sie eine beliebige Taste unten, um mit der Verwendung zu beginnen *${global.BotName}*
    
    ©️ *${global.BotName}* Alle Rechte reserviert von:*Fantox*
    `
...
await Miku.sendMessage(m.chat, { delete: key })
 ...
 replay('Deaktiviert twitter antilink !')
   ...
   let buttonsntilink = [
   { buttonId: `${prefix}antilinktwt on`, buttonText: { displayText: 'An' }, type: 1 },
   { buttonId: `${prefix}antilinktwt off`, buttonText: { displayText: 'Aus' }, type: 1 }
   <y<y]
   await Miku.sendButtonText(m.chat, buttonsntilink, `Bitte drücke auf den Button untenn\n"AN" zum Aktivierenn\n"Aus" zum Deaktivieren`, `${global.BotName}`, m)
   }
   }
   break
 ...
 replay('entfernt jeden antilink !')
   ...
   let buttonsntilink = [
   { buttonId: `${prefix}antilinkall on`, buttonText: { displayText: 'An' }, type: 1 },
   { buttonId: `${prefix}antilinkall off`, buttonText: { displayText: "Aus' }, type: 1 }
   ]
   await Miku.sendButtonText(m.chat, buttonsntilink,  `Bitte drücke auf den Button untenn\n"AN" zum Aktivierenn\n"Aus" zum Deaktivieren` `${global.BotName}`, m)
   }
   }
 ...
 if (!antiWame) return replay('bereits deaktiviert!')
 let off = nttoxic.indexOf(from)
 ntwame.splice(off, 1)
 replay('daktiviert antiwame !')
 } else {
   let buttonsntwame = [
   ...
   await Miku.sendButtonText(m.chat, buttonsntwame,  `Bitte drücke auf den Button untenn\n"AN" zum Aktivierenn\n"Aus" zum Deaktivieren` `${global.BotName}`, m)
   }
   }
   break
 ...
 Miku.sendMessage(from, {text: `\`\`\`「 Notice 」\`\`\`\n\nNSFW(nicht sicher zu nutzen) Funktion wurde in dieser Gruppe aktiviert, was bedeutet, dass jeder hier auf Adult-Befehle zugreifen kann!`, contextInfo: { mentionedJid : mems }}, {quoted:m})
 } else if (args[0] === "off") {
 if (!AntiNsfw) return replay('bereits aktiviert')
 let off = ntnsfw.indexOf(from)
 ntnsfw.splice(off, 1)
 replay('Deaktiviert NSFW Befehle!')
 } else {
   let buttonsntnsfw = [
   { buttonId: `${prefix}nsfw on`, buttonText: { displayText: 'An' }, type: 1 },
   { buttonId: `${prefix}nsfw off`, buttonText: { displayText: 'Aus' }, type: 1 }
   ]
   await Miku.sendButtonText(m.chat, buttonsntnsfw,  `Bitte drücke auf den Button untenn\n"AN" zum Aktivierenn\n"Aus" zum Deaktivieren` `${global.BotName}`, m)
   }
   }
   break
...
if (args[0] === "add") {
if (isBane) return ads('Benutzer ist  bereits gebannt.')
banUser.push(orgnye)
replay(`Benutzer erfolgreich gebannt.`)
} else if (args[0] === "del") {
if (!isBane) return ads('Benutzer ist bereits entbannt.')
let delbans = banUser.indexOf(orgnye)
banUser.splice(delbans, 1)
replay(`Benutzer erfolgreich entbannt.`)
} else {
replay("Error")
}
}
...
if (isBanChat) return reply(mess.bangc)
if (!isCreator) return replay(mess.botowner)
if (!args[0]) return replay(`Wähle "add" oder "del" ("add" zum  bannen, "del" zum entbannen), Zum Beispiel: Reply *${prefix}ban add* Zu dem Benutzer , den du bannen möchtest.`)
if (args[1]) {
orgnye = args[1] + "@s.whatsapp.net"
} else if (m.quoted) {
orgnye = m.quoted.sender
...
if (isBane) return ads('Benutzer ist bereits gebannt.')
banUser.push(orgnye)
replay(`Der Benutzer wurde erfolgreich gebannt`)
} else if (args[0] === "del") {
if (!isBane) return ads('Benutzer ist bereits entbannt.')
let delbans = banUser.indexOf(orgnye)
banUser.splice(delbans, 1)
replay(`Ber Benutzer wurde erfolgeich entbannt.`)
} else {
replay("Error")
}
}
...
case 'happymod': {
    if (isBan) return reply(mess.banned)	 			
 if (isBanChat) return reply(mess.bangc)
 if (!args.join(" ")) return replay(`Beispiel : ${prefix + command} Kinemaster`)
 yogipw.happymod(args.join(" ")).then(async(res) => {
 teks = '```「 HappyMod Such(e) Engine 」```'
 for (let i of res) {
 teks += `\n\n${i.name}\n`
 teks += `${i.link}`
 }
 ...
 let teks = '```「 YouTube Such(e) Engine 」```\n\n Search Term: '+text+'\n\n'
 let no = 1
 ...
 if (!isBotAdmins) return replay(mess.botadmin)
 if (!isAdmins && !isCreator) return replay(mess.useradmin)
 if (!text) return replay('Bitte schreibe   #setname <Neuer Gruppen Name> Um den Gruppennamen zu ändern , wechseln')
...
case'admin': {
 ...
 if (isBanChat) return reply(mess.bangc)
 if (!m.isGroup) return replay(mess.grouponly)
 if (!text) return replay(`*Bitte zitieren oder schreiben Sie eine aussagekräftige Nachricht, um Administratoren zu markieren*`)
 let teks = `*「 Makiere(n) Admin(s) 」*
...
let mentioned = participants.map(v => v.jid)
    ...
    case 'nowa':  case 'stalk': case 'stalknumber':{
        ...
        reply(`Suche nach WhatsApp-Konto in einem bestimmten Bereich...`)
 ...
 case 'resetlinkgc':
    ...
    case 'group': case 'grup': {
     ...
     let buttons = [
     { buttonId: `${prefix}group open`, buttonText: { displayText: 'Offen' }, type: 1 },
     { buttonId: `${prefix}group close`, buttonText: { displayText: 'Geschlossen' }, type: 1 }
     ]
     let buttonMessage = {
     image: BotLogo,
     jpegThumbnail: Thumb,
     caption: `*「 ${global.BotName} 」*\n\n_Gruppeneinstellungswechslertool_*:`,
     footer: `${BotName}`,
     buttons: buttons,
     headerType: 4
     }
     ...
     if (sizny < 20) {
     teks = `Entschuldigung, minimum 20 Mitglieder sind in einer Gruppe erforderlich, um Bot hinzuzufügen!`
     sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./Assets/pic7.jpg'), `${global.packname}`, `${global.BotName}`, "4917662927731@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
     } else if (sizny > 20) {
     await Miku.groupAcceptInvite(vcc).then(async(res) => replay(jsonformat(res))).catch(_ => _)
     replay("Joined !")
     } else {
...
reply(`\`\`\`「 _Taschenrechner Tool_ 」\`\`\`\n\n*Input :* ${qsd}\n*Taschenrechner Ergebnis :* ${mathjs.evaluate(qsd.replace(/×/g, "*").replace(/x/g, "*").replace(/÷/g, "/"))}`)
}
}
break
...
case 'toaud': case 'toaudio': {
    if (isBan) return reply(mess.banned)	 			
 if (isBanChat) return reply(mess.bangc)
 if (!/video/.test(mime) && !/audio/.test(mime)) return reply(`Senden/Beantworten von Video/Audio, das Sie als Audio mit Untertitel verwenden möchten ${prefix + command}`)
 if (!m.quoted) return reply(`Senden/Beantworten von Video/Audio, das Sie als Audio mit Untertitel verwenden möchten ${prefix + command}`)
 reply(mess.waiting)
...
case 'tomp3': {
    if (isBan) return reply(mess.banned)	 			
 if (isBanChat) return reply(mess.bangc)
 if (/document/.test(mime)) return reply(`Senden / Antworten Sie Video / Audio, das Sie in MP3 mit Untertitel konvertieren möchten${prefix + command}`)
 if (!/video/.test(mime) && !/audio/.test(mime)) return reply(`Senden / Antworten Sie Video / Audio, das Sie in MP3 mit Untertitel konvertieren möchten ${prefix + command}`)
 if (!m.quoted) return reply(`Senden / Antworten Sie Video / Audio, das Sie in MP3 mit Untertitel konvertieren möchten ${prefix + command}`)
 reply(mess.waiting)
 let media = await quoted.download()
 let { toAudio } = require('./lib/converter')
 let audio = await toAudio(media, 'mp4')
 Miku.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Konvertiert von:  ${global.BotName} (${m.id}).mp3`}, { quoted : m })
 }
break
...
if (isBanChat) return reply(mess.bangc)
if (args[0] === "mp4") {
Miku.sendMessage(from, {video:{url:args[1]}, caption:'Hier ist es...', mimetype:'video/mp4'}, {quoted:m})
} else if (args[0] === "jpg") {
Miku.sendMessage(from, {image:{url:args[1]}, caption:'Hier ist es...'}, {quoted:m})
} else {
reply("Error! ")
}
}
...
if (isBanChat) return reply(mess.bangc)
 ...
 try {
 Miku.sendMessage(from, {image:{url:args[0]}, caption:"Erfolgreich!"}, {quoted:m})
 } catch {
 reply("Link error")
 }
 }
